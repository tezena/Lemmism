...
function BlogECard({ image, title, text, buttonText}){
  return (
    <div class="col-md-10 p-5 p-md-1 mx-auto ">
      <div class="row g-0 border rounded overflow-hidden flex-md-row-reverse mb-4 shadow-sm h-md-250 position-relative">
        ...
        <div class="col-auto col-md-4 d-none d-lg-block">
          <svg
            class="bd-placeholder-img w-100 "
            width="200"
            height="250"
            xmlns="assets/images/img3.jpg"
            role="img"
            aria-label="Placeholder: Thumbna"
